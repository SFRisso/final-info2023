...
function ProductCard(props) {
    ...
    return (
            ...
            <Card className='h-100'>
                ...
                <Card.Title className="link-primary link-offset-2 link-underline-opacity-75 link-underline-opacity-100-hover fw-bold" as={Link} to={`/products/${props.id}`}>{props.title}</Card.Title>
