        ...
        <Card className="p-0 bg-warning-subtle mb-2">
            <Card.Body className="px-2 py-1">
                <Row className="align-items-center">
                    ...
                    <Card.Img variant="top" src={props.image}  className="img-thumbnail " />
                    </Col>
                    ...
                    <Col className="col-md-3 col-7 text-center mb-2 pe-5">
                        ...
                        <Card.Text className="fw-medium">Total: ${props.price * quantityState}</Card.Text>
                    </Col>
                </Row>
                
                <Row className="justify-content-center">
                <Col className='col-10 col-sm-8 col-md-3 col-lg-2'>
